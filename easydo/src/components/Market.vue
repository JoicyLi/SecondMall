<template>
	<div id="market">
		<div id="left_menu">
			<div class="bar">
				<img class="img" src="../assets/Main.jpg" @click="goTo('/market/commodity', 'Commodity')">
			</div>
			<div class="bar">
				<img class="img" src="../assets/Products.jpg" @click="goTo('/market/cart', 'ShopCart')">
			</div>
			<div class="bar">
				<img class="img" src="../assets/Support.jpg" @click="goTo('/market/message', 'Message')">
			</div>
			<div class="bar">
				<img class="img" src="../assets/Billing.jpg" @click="goTo('/market/order', 'Order')">
			</div>
			<div class="bar">
				<img class="img" src="../assets/Account.jpg" @click="goTo('/market/account', 'Account')">
			</div>
		</div>
